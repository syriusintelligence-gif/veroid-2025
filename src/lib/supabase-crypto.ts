...
function dbSignedContentToAppSignedContent(
  ...
  return {
    ...
    // 🎠 Metadados do carrossel - conversão direta como no arquivo de referência
...
export async function signContent(
  ...
  try {
    ...
    console.log('📊 [PLATFORMS] Plataformas recebidas:', platforms);
    ...
    console.log('📊 [PLATFORMS] Plataformas que serão salvas:', signedContent.platforms);

        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4 md:space-y-6 max-w-4xl mx-auto">
            <p className="text-base md:text-xl lg:text-2xl text-gray-300 leading-relaxed text-center px-4">
              <strong className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">Mantenha a sua reputação</strong> protegida contra falsificações. Assine digitalmente todo seu conteúdo, e tenha certificação e autoria comprovada de maneira instantânea.
            </p>
          </motion.div>
      ...
      <section ref={benefitsRef} className="relative py-12 md:py-16 lg:py-20 bg-gradient-to-b from-slate-950 to-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, y: shouldReduceMotion ? 0 : 40 }}
            animate={benefitsInView ? { opacity: 1, y: 0 } : { opacity: 0, y: shouldReduceMotion ? 0 : 40 }}
            transition={{ duration: shouldReduceMotion ? 0.01 : 0.7, delay: shouldReduceMotion ? 0 : 0.8, ease: [0.25, 0.1, 0.25, 1] }}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <Card className="glass-card glass-noise border-2 border-red-500/30 h-full overflow-hidden relative">
                  <CardHeader className="text-center pb-4">
                    <div className="mx-auto w-16 h-16 border-4 border-red-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-red-500/30 bg-transparent">
                  ...
                  <CardContent className="space-y-3">
                    {[
                      ...
                      <motion.div
                        ...
                        transition={{ duration: shouldReduceMotion ? 0.01 : 0.5, delay: shouldReduceMotion ? 0 : 0.9 + (index * 0.1) }}
                  ...
                  {/* Diagonal cut effect */}
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-red-500/20 to-transparent transform rotate-45 translate-x-12 -translate-y-12"></div>
                </Card>
              </motion.div>
